...
const JobForm: React.FC<JobFormProps> = ({
  ...
  return (
    <form onSubmit={onSubmit} className="mb-4">
      ...
      <div className="mb-4">
        <label htmlFor="company.logo" className="block text-gray-700">
          Company Logo URL
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="company.logoBackground" className="block text-gray-700">
      ...
      <div className="mb-4">
        <label htmlFor="requirements.content" className="block text-gray-700">
      ...
      <ArrayField
        ...
        onChangeItem={(index, value) =>
          onArrayChange("requirements", index, value)
        }
      />
      <div className="mb-4">
        <label htmlFor="qualifications.content" className="block text-gray-700">
      ...
      <ArrayField
        ...
        onChangeItem={(index, value) =>
          onArrayChange("qualifications", index, value)
        }
      />
      <div className="mb-4">
        <label
          htmlFor="responsibilities.content"
      ...
      <ArrayField
        ...
        onChangeItem={(index, value) =>
          onArrayChange("responsibilities", index, value)
        }
      />
      <div className="mb-4">
        <label htmlFor="skills.content" className="block text-gray-700">
          Skills Content
        </label>
        <textarea
          name="skills.content"
      ...
      />
      <div className="mb-4">
        <label htmlFor="benefits.content" className="block text-gray-700">
          Benefits Content
        </label>
        <textarea
      ...
      />
      <div className="mb-4">
        <label htmlFor="role.content" className="block text-gray-700">
          Role Content
        </label>
        <textarea
          name="role.content"
